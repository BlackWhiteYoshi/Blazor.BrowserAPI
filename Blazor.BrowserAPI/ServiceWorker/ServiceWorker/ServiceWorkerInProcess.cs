...
internal sealed class ServiceWorkerInProcess : ServiceWorkerBase, IServiceWorkerInProcess {
    ...
    public ServiceWorkerInProcess(IModuleManager moduleManager, IJSInProcessObjectReference serviceWorker) : base(moduleManager) {
    ...
    /// </summary>
    public string ScriptUrl => _moduleManager.InvokeSync<string>("serviceWorkerScriptURL", _serviceWorker);
    ...
    /// </summary>
    public string State => _moduleManager.InvokeSync<string>("serviceWorkerState", _serviceWorker);
    ...
    public void PostMessage(object message) => _moduleManager.InvokeSync("serviceWorkerPostMessage", _serviceWorker, message);
}
