import { ClipboardAPI } from "./BrowserAPIs/Clipboard/Clipboard";
export { ClipboardAPI };

import { ConsoleAPI } from "./BrowserAPIs/Console/Console";
export { ConsoleAPI };
...
import { PermissionsAPI } from "./BrowserAPIs/Permissions/Permissions";
