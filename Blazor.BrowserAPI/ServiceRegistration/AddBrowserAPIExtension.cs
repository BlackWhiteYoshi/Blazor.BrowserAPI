...
public static class AddBrowserAPIExtension {
    ...
    public static IServiceCollection AddBrowserAPI(this IServiceCollection services) {
        services.AddScoped<IModuleManager, Implementation.ModuleManager>()
            ...
            .AddScoped<ILanguage, Implementation.Language>() // Obsolete
            .AddScoped<ILanguageInProcess, Implementation.LanguageInProcess>() // Obsolete
            ...
            .AddScoped<INavigator, Implementation.Navigator>()
            .AddScoped<INavigatorInProcess, Implementation.NavigatorInProcess>()
            ...
            .AddScoped<IPermissions, Implementation.Permissions>()
            .AddScoped<IPermissionsInProcess, Implementation.PermissionsInProcess>()
