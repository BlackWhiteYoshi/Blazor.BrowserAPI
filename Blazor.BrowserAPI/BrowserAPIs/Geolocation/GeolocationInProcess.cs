...
public sealed class GeolocationInProcess(IModuleManager moduleManager) : GeolocationBase(moduleManager), IGeolocationInProcess {
    /// <summary>
    ...
    public void GetCurrentPosition(Action<GeolocationCoordinates> successCallback, Action<int, string>? errorCallback = null, long maximumAge = 0, long timeout = -1, bool enableHighAccuracy = false) {
        ...
        moduleManager.InvokeSync("GeolocationAPI.getCurrentPosition", [callbackGeolocation, true, maximumAge, timeout, enableHighAccuracy]);
    }
