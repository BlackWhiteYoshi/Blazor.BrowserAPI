...
public sealed class GeolocationInProcess(IModuleManager moduleManager) : IGeolocationInProcess {
    /// <summary>
    ...
    /// </param>
    /// <returns></returns>
    public void GetCurrentPosition(Action<GeolocationCoordinates, long> successCallback, Action<int, string>? errorCallback = null, long maximumAge = 0, long timeout = -1, bool enableHighAccuracy = false) {
