...
public sealed class MediaRecorderInProcess(IJSInProcessObjectReference mediaRecorderJS) : MediaRecorderBase, IMediaRecorderInProcess {
    private protected override IJSObjectReference MediaRecorderJS => mediaRecorderJS;
