...
export class MediaDevicesAPI {
     ...
     * @returns {Promise<MediaStreamAPI>}
     */
    static async getUserMedia(audio, video) {
     ...
     * @returns {Promise<MediaStreamAPI>}
     */
    static async getDisplayMedia(audio, video) {
     ...
     */
    static #convertToMediaTrackConstraintSet(constrainMediaTrack) {
