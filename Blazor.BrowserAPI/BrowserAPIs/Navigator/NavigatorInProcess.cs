...
public sealed class NavigatorInProcess(IModuleManager moduleManager) : NavigatorBase(moduleManager), INavigatorInProcess {
    /// <summary>
    ...
    /// </summary>
    public string Language => moduleManager.InvokeSync<string>("NavigatorAPI.getLanguage");
    ...
    /// <para>When its value changes, as the user's preferred languages are changed a <see cref="IWindowInProcess.OnLanguageChange"/> event is fired on the <see cref="IWindowInProcess"/> object.</para>
    /// <para>
    ...
    /// </para>
    /// </summary>
    public string[] Languages => moduleManager.InvokeSync<string[]>("NavigatorAPI.getLanguages");
    ...
    /// </para>
    /// </remarks>
    public string UserAgent => moduleManager.InvokeSync<string>("NavigatorAPI.getUserAgent");
    ...
    /// </para>
    /// </summary>
    public bool Webdriver => moduleManager.InvokeSync<bool>("NavigatorAPI.getWebdriver");
    ...
    /// </para>
    /// </summary>
    public bool UserActivationIsActive => moduleManager.InvokeSync<bool>("NavigatorAPI.getUserActivationIsActive");
    ...
    /// </para>
    /// </summary>
    public bool UserActivationHasBeenActive => moduleManager.InvokeSync<bool>("NavigatorAPI.getUserActivationHasBeenActive");
    ...
    /// </remarks>
    public bool CookieEnabled => moduleManager.InvokeSync<bool>("NavigatorAPI.getCookieEnabled");
    ...
    public bool PdfViewerEnabled => moduleManager.InvokeSync<bool>("NavigatorAPI.getPdfViewerEnabled");


    /// <summary>
    /// Returns the maximum number of simultaneous touch contact points that are supported by the current device.
    /// </summary>
    public int MaxTouchPoints => moduleManager.InvokeSync<int>("NavigatorAPI.getMaxTouchPoints");
    ...
    /// </para>
    /// </summary>
    public int HardwareConcurrency => moduleManager.InvokeSync<int>("NavigatorAPI.getHardwareConcurrency");
    ...
    /// </para>
    /// </summary>
    public double DeviceMemory => moduleManager.InvokeSync<double>("NavigatorAPI.getDeviceMemory");
    ...
    /// <returns></returns>
    public bool CanShare(string? url = null, string? text = null, string? title = null, IFileInProcess[]? files = null) {
        IJSInProcessObjectReference[]? filesJS = null;
        if (files is not null) {
            filesJS = new IJSInProcessObjectReference[files.Length];
            for (int i = 0; i < filesJS.Length; i++)
                filesJS[i] = files[i].FileJS;
        }

        return moduleManager.InvokeSync<bool>("NavigatorAPI.canShare", [url, text, title, filesJS]);
    }
    ...
    /// <returns></returns>
    public ValueTask Share(string? url = null, string? text = null, string? title = null, IFileInProcess[]? files = null, CancellationToken cancellationToken = default) {
        IJSInProcessObjectReference[]? filesJS = null;
        if (files is not null) {
            filesJS = new IJSInProcessObjectReference[files.Length];
            for (int i = 0; i < filesJS.Length; i++)
    ...
    /// </param>
    public void RegisterProtocolHandler(string scheme, string url) => moduleManager.InvokeSync("NavigatorAPI.registerProtocolHandler", [scheme, url]);
    ...
    public void UnregisterProtocolHandler(string scheme, string url) => moduleManager.InvokeSync("NavigatorAPI.unregisterProtocolHandler", [scheme, url]);
    ...
    /// <returns></returns>
    public bool SendBeacon(string url, string? data = null) => moduleManager.InvokeSync<bool>("NavigatorAPI.sendBeacon_String", [url, data]);

    /// <inheritdoc cref="SendBeacon(string, string?)" />
    public bool SendBeacon(string url, byte[] data) => moduleManager.InvokeSync<bool>("NavigatorAPI.sendBeacon_Bytes", [url, data]);
    ...
    /// </param>
    /// <returns></returns>
    public bool Vibrate(int[] pattern) => moduleManager.InvokeSync<bool>("NavigatorAPI.vibrate", [pattern]);
    ...
    /// </param>
    /// <returns></returns>
    public string GetAutoplayPolicy(string type) => moduleManager.InvokeSync<string>("NavigatorAPI.getAutoplayPolicy_String", [type]);

    /// <inheritdoc cref="GetAutoplayPolicy(string)" />
    /// <param name="element">A specific media element.</param>
    /// <returns></returns>
    public string GetAutoplayPolicy(IHTMLMediaElementInProcess element) => moduleManager.InvokeSync<string>("NavigatorAPI.getAutoplayPolicy_Element", [element.HTMLMediaElementJS]);
}
