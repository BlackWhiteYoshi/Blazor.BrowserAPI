...
public sealed class FileSystem(IModuleManager moduleManager) : FileSystemBase(moduleManager), IFileSystem {
    ...
    /// <returns></returns>
    public async ValueTask<IFileHandle> ShowOpenFilePicker(string? id = null, PickerDialogStartIn startIn = default, bool excludeAcceptAllOption = false, (string description, (string MIMEtype, string[] fileExtensions)[] accept)[]? types = null, CancellationToken cancellationToken = default) {
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public async ValueTask<IFileHandle[]> ShowOpenFilePickerMultipleFiles(string? id = null, PickerDialogStartIn startIn = default, bool excludeAcceptAllOption = false, (string description, (string MIMEtype, string[] fileExtensions)[] accept)[]? types = null, CancellationToken cancellationToken = default) {
        ...
        FileHandle[] result = new FileHandle[fileHandleJSList.Length];
        for (int i = 0; i < result.Length; i++)
            result[i] = new FileHandle(fileHandleJSList[i]);
        return result;
    }
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public async ValueTask<IFileHandle> ShowSaveFilePicker(string? suggestedName = null, string? id = null, PickerDialogStartIn startIn = default, bool excludeAcceptAllOption = false, (string description, (string MIMEtype, string[] fileExtensions)[] accept)[]? types = null, CancellationToken cancellationToken = default) {
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public async ValueTask<IDirectoryHandle> ShowDirectoryPicker(string mode = "read", string? id = null, PickerDialogStartIn startIn = default, CancellationToken cancellationToken = default) {
        IJSObjectReference directoryHandleJS = await ShowDirectoryPickerBase(mode, id, startIn, cancellationToken);
        return new DirectoryHandle(directoryHandleJS);
    }
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public async ValueTask<IDirectoryHandle> StorageManagerGetDirectory(CancellationToken cancellationToken = default) {
