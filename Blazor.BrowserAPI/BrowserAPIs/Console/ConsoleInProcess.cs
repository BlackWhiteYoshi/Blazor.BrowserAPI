...
public sealed class ConsoleInProcess(IModuleManager moduleManager) : IConsoleInProcess {
    ...
    /// <summary>
    /// <para>
    /// Creates a new inline group in the Web Console. Unlike <see cref="Group()"/>, however, the new group is created collapsed.
    ...
    /// <inheritdoc cref="GroupCollapsed()" />
    /// <param name="label">Label for the group.</param>
    ...
    /// <summary>
    /// Stops a timer that was previously started by calling <see cref="Time()"/>.
    /// </summary>
    public void TimeEnd() => moduleManager.InvokeSync("ConsoleAPI.timeEnd");

    /// <summary>
    /// Stops a timer that was previously started by calling <see cref="Time(string)"/>.
    /// </summary>
    /// <param name="label">
    ...
    /// <summary>
    /// Logs the current value of a timer that was previously started by calling <see cref="Time()"/>.
    /// </summary>
    public void TimeLog() => moduleManager.InvokeSync("ConsoleAPI.timeLog");

    /// <summary>
    /// Logs the current value of a timer that was previously started by calling <see cref="Time(string)"/>.
    /// </summary>
    ...
    /// <inheritdoc cref="TimeLog(string)" />
    /// <param name="label">The name of the timer to log to the console. If this is omitted the label "default" is used.</param>
